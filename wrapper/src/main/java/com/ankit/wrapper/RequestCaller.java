...
/**
 * Created by ankitagrawal on 13/7/16.
 */
public class RequestCaller {
    private int method = Request.Method.POST;
    private String requestUrl;
    private JSONObject jsonObject;
    private IParsedResponseListener<JSONObject,?> iParsedResponseListener;
    ...
    private RequestCaller(Builder builder) {
    ...
    public static Builder newBuilder(@NonNull RequestCaller copy) {
        ...
        builder.mParams = copy.mParams;
        return builder;
    }

    /**
     * {@code RequestCaller} builder static inner class.
     */
    public static final class Builder implements IBuildRequestType{
        ...
        private IBuildOptions iBuildOptions = new IBuildOptions() {
             ...
             */
                ...
                CacheRequestHandler.getInstance().makeJsonRequest(context, method, requestUrl,
                        ...
                        networkPolicy,cacheTime, iParsedResponseListener,null);
            }

            @Override
            public IBuildOptions callback(@NonNull IParsedResponseListener val) {
                return null;
            }
            ...
            @Override
            public IBuildOptions asJsonObject(@NonNull IParsedResponseListener<JSONObject,?> val) {
                iParsedResponseListener = val;
                return this;
            }

            @Override
            public IBuildOptions asGsonObject(@NonNull IResponseListener<?,?> val) {
                return null;
            }

            @Override
            public IBuildOptions modelClass(@NonNull Class mClass, @NonNull IParsedResponseListener<?, ?> val) {
                return null;
            }

            @Override
            public IBuildOptions asString(@NonNull IParsedResponseListener<String,?> val) {
                iParsedResponseListener = val;
                return this;
            }
        ...
        /**
         * Returns a {@code RequestCaller} built from the parameters previously set.
         *
         * @return a {@code RequestCaller} built with parameters of this {@code RequestCaller.Builder}
         */
        @NonNull
      //  @Override
        public RequestCaller build() {
            return new RequestCaller(this);
        }
    }
}
